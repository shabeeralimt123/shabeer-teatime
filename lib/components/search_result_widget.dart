...
import 'package:teatime/components/search_item.dart';
          ...
          Padding(
            ...
            child: ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () {
                  BlocProvider.of<ProductsCubit>(context)..emptyProducts();
                ...
                if (state is ProductsLoaded) {
                  return ListView(
                    ...
                    children: [
                      ...state.products
                          .map((e) => BlocProvider(
                              create: (context) => UnitCubit()..getUnits(id: int.parse(e.unit)),
                              child: SearchItem(
                                productModel: e,
                              )))
                          .toList()
